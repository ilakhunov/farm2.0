    ...
    try {
      ...
      if (e is Exception) {
        ...
        if (errorMessage.isEmpty || errorMessage == 'null') {
          errorMessage = 'Ошибка при создании товара. Проверьте подключение к интернету и попробуйте снова.';
        }
      } else {
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              // Единица измерения с выпадающим списком
              DropdownButtonFormField<String>(
                value: _selectedUnit,
                decoration: const InputDecoration(
                ...
                items: const [
                  DropdownMenuItem(value: 'kg', child: Text('кг (килограмм)')),
                  DropdownMenuItem(value: 'g', child: Text('г (грамм)')),
                  DropdownMenuItem(value: 'piece', child: Text('шт (штука)')),
                  DropdownMenuItem(value: 'liter', child: Text('л (литр)')),
                  DropdownMenuItem(value: 'ml', child: Text('мл (миллилитр)')),
                  DropdownMenuItem(value: 'box', child: Text('коробка')),
                  DropdownMenuItem(value: 'bag', child: Text('мешок')),
                ],
                onChanged: (value) {
                  if (value != null) {
                    setState(() {
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'После создания товар будет доступен в каталоге для магазинов',
                        style: TextStyle(
